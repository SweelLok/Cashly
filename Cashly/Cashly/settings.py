"""
Django settings for Cashly project.
...
SECRET_KEY = 'django-insecure-ielvaq6m=c8@$_v)yjjf!focswpm)nek5*8lgsu+k#i4jj=l9d'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['god1k.pythonanywhere.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'Cashly.wsgi.application'
